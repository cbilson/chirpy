...
namespace T4MVCTest.Controllers {
    public partial class AccountController {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult LogOnToMe() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.LogOnToMe);
        }
        ...
        public class ActionNamesClass {
            ...
            public readonly string LogOnToMe = "LogOnToMe";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: T4MVCTest.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult LogOnToMe(T4MVCTest.Models.LogOnModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.LogOnToMe);
        ...
        public override System.Web.Mvc.ActionResult Register(T4MVCTest.Models.RegisterModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult ChangePassword(T4MVCTest.Models.ChangePasswordModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.ChangePassword);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }
